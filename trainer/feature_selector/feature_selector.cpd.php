...
/* CONSTANTS */
define("CPD_THRESHOLD", 0.125);
define("MAX_ALLOWED_PERCENTAGE", 0.001);
...
function writeWordBankToJSON($file)
{
	...
	file_put_contents($file.".cpd.".constant("CPD_THRESHOLD").".".constant("MAX_ALLOWED_PERCENTAGE").".json", json_encode($wordBank));
}
?>
